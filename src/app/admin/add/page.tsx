...
const REGISTER_SECRET =
  process.env.NEXT_PUBLIC_REGISTER_SECRET || "adminSecret2025";
...
export default function AddCarPage() {
  ...
  const handleFacebookUrlChange = (url: string) => {
    setForm((prev) => ({ ...prev, facebookPostUrl: url }));
    if (errors.facebookPostUrl) {
      setErrors((prev) => ({ ...prev, facebookPostUrl: undefined }));
    }
  };

  const handleFacebookEmbedCodeChange = (code: string) => {
    setForm((prev) => ({ ...prev, facebookEmbedCode: code }));
    if (errors.facebookEmbedCode) {
      setErrors((prev) => ({ ...prev, facebookEmbedCode: undefined }));
    }
  };
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files) {
      ...
      if (files.length > 12) {
        setErrors((prev) => ({
          ...prev,
          images: "Poți selecta maxim 12 imagini",
        }));
        setImages([]);
        setImageUrls([]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newTimeoutId = setTimeout(() => {
        ...
        if (
          window.confirm(
            "Anunțul a fost adăugat cu succes! Vrei să vezi lista de anunțuri?"
          )
        ) {
      ...
      setError(
        err instanceof Error
          ? err.message
          : "A apărut o eroare la adăugarea mașinii"
      );
    } finally {
      setLoading(false);
    }
                ...
                <form onSubmit={handleSubmit} className="needs-validation">
                  <div className="row g-3">
                    ...
                    <div className="col-md-3">
                      ...
                      />
                      {errors.an && (
                        <div className="invalid-feedback">{errors.an}</div>
                      )}
                    </div>
                    ...
                    <div className="col-md-3">
                      ...
                      />
                      {errors.pret && (
                        <div className="invalid-feedback">{errors.pret}</div>
                      )}
                    </div>
                    ...
                    <div className="col-md-3">
                      ...
                      />
                      {errors.km && (
                        <div className="invalid-feedback">{errors.km}</div>
                      )}
                    </div>
                    ...
                    <div className="col-md-3">
                      ...
                      />
                      {errors.putere && (
                        <div className="invalid-feedback">{errors.putere}</div>
                      )}
                    </div>
                    ...
                    <div className="col-12">
                      ...
                      />
                      {errors.dotari && (
                        <div className="invalid-feedback">{errors.dotari}</div>
                      )}
                    </div>
                    ...
                    <div className="col-md-6">
                      ...
                      />
                      {errors.locatie && (
                        <div className="invalid-feedback">{errors.locatie}</div>
                      )}
                    </div>

                    <div className="col-12">
                      <label className="form-label">
                        Link extern (OLX/Autovit)
                      </label>
                      <input
                        type="url"
                        className={`form-control ${
                          errors.linkExtern ? "is-invalid" : ""
                        }`}
                        name="linkExtern"
                    ...
                    <div className="col-12">
                      <FacebookPostEmbed
                        ...
                        facebookEmbedCode={form.facebookEmbedCode}
                        onUrlChange={handleFacebookUrlChange}
                        onEmbedCodeChange={handleFacebookEmbedCodeChange}
                        disabled={loading}
                        error={
                          errors.facebookPostUrl || errors.facebookEmbedCode
                        }
                      />
                    </div>
